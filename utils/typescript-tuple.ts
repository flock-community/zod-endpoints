import { Extends, Equal } from "./typescript-compare.ts";

export type IsFinite<Tuple extends any[], Finite, Infinite> = {
  empty: Finite;
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? IsFinite<Rest, Finite, Infinite>
    : never;
  infinite: Infinite;
}[
  Tuple extends [] ? "empty"
    : Tuple extends (infer Element)[] ? Element[] extends Tuple ? "infinite"
    : "nonEmpty"
    : never
];
...
export type SplitInfiniteTuple<Tuple extends any[]> =
  _SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[] ? [Reverse<Finite>, Infinite]
    : never
    : never;

export type _SplitInfiniteTuple<
  Tuple extends any[],
  Holder extends any[] = [],
> = {
...
export type First<Tuple extends any[], Default = never> = Tuple extends
  [any, ...any[]] ? Tuple[0] : Default;

export type Last<Tuple extends any[], Default = never> = {
  empty: Default;
  single: Tuple extends [infer SoleElement] ? SoleElement : never;
  multi: ((..._: Tuple) => any) extends ((_: any, ..._1: infer Next) => any)
    ? Last<Next>
    : Default;
...
export type Tail<Tuple extends any[]> = ((...args: Tuple) => any) extends
  ((_: any, ..._1: infer Rest) => any) ? Rest
  : never;
...
> = {
  ...
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? Equal<First, Type> extends true ? Count["length"]
  ...
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[] ? FirstIndexEqual<
      Type,
      Finite,
      Infinite extends Type[] ? Type[] extends Infinite ? Finite["length"]
      : NotFound
        : NotFound
    >
    : never
...
> = {
  ...
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? Extends<First, Type> extends true ? Count["length"]
    : FirstIndexSubset<Type, Rest, NotFound, Prepend<Count, any>>
    : never;
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[] ? FirstIndexSubset<
      Type,
      Finite,
...
> = {
  ...
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? Extends<Type, First> extends true ? Count["length"]
    : FirstIndexSuperset<Type, Rest, NotFound, Prepend<Count, any>>
    : never;
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[] ? FirstIndexSuperset<
      Type,
      Finite,
...
> = {
  ...
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? Rest extends any[] ? _AllIndexesEqual<
      Type,
      Rest,
      Equal<First, Type> extends true ? Prepend<Holder, Count["length"]>
        : Holder,
      Prepend<Count, any>
    >
    : never
    : never;
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[] ? Infinite extends (infer Last)[] ? _AllIndexesEqual<
      Type,
      Finite,
...
> = {
  ...
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? Rest extends any[] ? _AllIndexesSubset<
      Type,
      Rest,
      Extends<First, Type> extends true ? Prepend<Holder, Count["length"]>
        : Holder,
      Prepend<Count, any>
    >
    : never
  ...
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[]
      ? Infinite extends (infer Last)[] ? _AllIndexesSubset<
        Type,
        Finite,
...
> = {
  ...
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any)
    ? Rest extends any[] ? _AllIndexesSuperset<
      Type,
      Rest,
  ...
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[]
      ? Infinite extends (infer Last)[] ? _AllIndexesSuperset<
        Type,
        Finite,
...
export type Prepend<Tuple extends any[], Addend> =
  ((_: Addend, ..._1: Tuple) => any) extends ((..._: infer Result) => any)
    ? Result
    : never;
...
export type Reverse<Tuple extends any[], Prefix extends any[] = []> = {
  empty: Prefix;
  nonEmpty: ((..._: Tuple) => any) extends
    ((_: infer First, ..._1: infer Next) => any)
  ...
  Tuple extends [any, ...any[]] ? IsFinite<Tuple, "nonEmpty", "infinite">
    : "empty"
];

export type Concat<Left extends any[], Right extends any[]> = {
  emptyLeft: Right;
  singleLeft: Left extends [infer SoleElement] ? Prepend<Right, SoleElement>
    : never;
  multiLeft: ((..._: Reverse<Left>) => any) extends
    ((_: infer LeftLast, ..._1: infer ReversedLeftRest) => any)
...
export type ConcatMultiple<TupleSet extends any[][]> = {
  ...
  nonEmpty: ((..._: Reverse<TupleSet>) => any) extends
    ((_: infer Last, ..._1: infer ReversedRest) => any)
    ? Last extends any[]
...
> = {
  matched: Tuple;
  unmatched: ((...args: Tuple) => any) extends
    ((_: any, ..._1: infer Rest) => any)
...
> = {
  ...
  start: ((...args: Tuple) => any) extends
    ((_: infer First, ..._1: infer Rest) => any) ? SliceStartQuantity<
    Rest,
    Start,
    Quantity,
...
export type SingleTupleSet<Types extends any[], Holder extends [any][] = []> = {
  empty: Holder;
  nonEmpty: ((..._: Reverse<Types>) => any) extends
    ((_: infer Last, ..._1: infer ReversedRest) => any)
...
> = {
  empty: Holder;
  nonEmpty: ((...a: Tuple) => any) extends
    ((a: infer First, ...b: infer Rest) => any)
...
export type ShortestTuple<TupleSet extends any[][], Shortest = any[]> = {
  empty: Shortest;
  nonEmpty: ((..._: TupleSet) => any) extends
    ((_: infer Head, ..._1: infer Tail) => any)
    ? Tail extends any[]
      ? Shortest extends any[]
        ? Head extends any[]
          ? Tail extends Head[] ? SortTwoTuple<Shortest, Head>[0]
...
export type LongestTuple<TupleSet extends any[][], Longest = []> = {
  ...
  nonEmpty: ((..._: TupleSet) => any) extends
    ...
    ? Tail extends any[]
      ? Longest extends any[]
        ? Head extends any[]
          ? Tail extends Head[] ? SortTwoTuple<Longest, Head>[1]
